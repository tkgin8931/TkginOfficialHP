...
interface ConnecttionStatusProps {
    status: "connected"| "disconnected" |"connecting"
}

export function ConnectionStatus({ status }: ConnecttionStatusProps){
    if( status === "connected"){
        return (
        ...
        return (
            <Badge variant="outline" className="bg-red-50 text-red-700 border-red-2000 flex gap-1 items-center">
