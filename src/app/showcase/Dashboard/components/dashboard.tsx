...
import { MagnetometerCompass } from "./magnetometer-compass"
    ...
    <div className="container mx-auto p-4">
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">センサーデータダッシュボード</h1>
            <p className="text-muted-foreground">リアルタイムセンサーデータの可視化と分析</p>
          </div>
        ...
        {connectionStatus === "disconnected" && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              WebSocketサーバーに接続できません。サーバーが実行中であることを確認してください。
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <Card className="col-span-1">
            <CardHeader>
              <CardTitle>加速度センサー可視化</CardTitle>
          ...
          <Card className="col-span-1">
            <CardHeader>
              <CardTitle>地磁気コンパス</CardTitle>
              <CardDescription>磁場データに基づく方位表示</CardDescription>
            </CardHeader>
            <CardContent className="h-[300px]">
              <MagnetometerCompass data={currentData?.magnetometer} />
            </CardContent>
          </Card>
        </div>
